...
export class Game{
    #scoreboard: ResultPanel = new ResultPanel();
    // player: Player;
    // problemCount: number;
    // factor: number;
    ...
    //parameter properties - need to add access modifiers to parameters in the contructor
    constructor(public player: Player, public problemCount: number, public factor: number){
    } //here parameters are intitalized on object creation/ constructor call and can be used directly
